...
#define MAXM 26
#define MAXN 8
int col[2][MAXN] = {{0,  1,  3,  7, 12, 16, 21, 23}, 
					{0,  2,  4,  9, 13, 18, 22, 24}};
int row[2][MAXN] = {{0,  5,   6,  7,  8,   9, 10, 11}, 
...
void mv(int board[], const int dir)
{
	int tmp, i;
	switch(dir)
	{
...
void dfs(int board[], const int pre, const int dp, const int maxdp)
{
	int f = heur(board);
	int tmp[MAXM], i;
